            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: [
                  const DropdownMenuItem(
                      value: null, child: Text('Select State / Region')),
                  ..._tourismMap.keys
              ...
              if (_selectedState != null) ...[
                DropdownButtonFormField<String>(
                  ...
                  items: [
                    const DropdownMenuItem(
                        value: null, child: Text('All Destinations')),
                    ...?_tourismMap[_selectedState]?.map(
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  final documentPaths =
                      _uploadedFiles.map((f) => f.path).toList();
                  final documentsJson =
                      documentPaths.join('|'); // Serialize file paths
                  ...
                  final newLand = Land(
                    ...
                    legalDocuments:
                        documentsJson.isNotEmpty ? documentsJson : null,
